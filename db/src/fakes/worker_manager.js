...
class FakeWorkerManager {
  ...
  async get_worker_pool_with_capacity(worker_pool_id) {
    ...
    for (const worker_pool of list) {
      worker_pool.existing_capacity = await this._capacity_for_pool(worker_pool_id);
    }
    return list;
  }
  ...
  async get_worker_pools_with_capacity(page_size, page_offset) {
    ...
    for (const worker_pool of list) {
      worker_pool.existing_capacity = await this._capacity_for_pool(worker_pool.worker_pool_id);
    }
    return list;
  }
